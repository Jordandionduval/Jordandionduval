/************* DISCLAIMER **************/
// I do not own any of this. All source material below are provided for free here here: www.bencloward.com/dvds/HLSL_Shader_DVD1.rar // DVDs are here: https://www.youtube.com/watch?v=MKio4MNM3CI&list=PL78XDi0TS4lEMvytsE_MoWEpzBcukXv9b&index=1
// Source: CG Academy HLSL Shader DVD Set, Ben Cloward, 2007
...
v2f v(a2v In, uniform float4 lightPosition)
{
    ...
    Out.worldBinormal = mul(In.normal, WorldInverseTranspose).xyz;  //put the binormal in world space pass it to the pixel shader
    Out.worldTangent = mul(In.normal, WorldInverseTranspose).xyz;   //put the tangent in world space pass it to the pixel shader
